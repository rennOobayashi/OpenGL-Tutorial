...
void openglcode::set_n_run() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		light_shader.set_vec3("light.position", camera_pos);
		light_shader.set_vec3("light.direction", camera_front);
		light_shader.set_float("light.cutoff_in", glm::cos(glm::radians(15.0f)));
		light_shader.set_float("light.cutoff_out", glm::cos(glm::radians(21.0f)));
		...
		light_shader.set_float("light.constant", 1.0f);
		light_shader.set_float("light.linear", 0.09f);
		light_shader.set_float("light.quadratic", 0.032f);
